  ...
  return (
    <div className="min-h-[100dvh] bg-background text-foreground flex flex-col">
      ...
      <main className="flex-1">
        <section className="max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary text-secondary-foreground text-xs font-medium mb-6">
            ...
            A self-paced, one-unit course in criminal psychology
          </div>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-primary leading-tight mb-5">
            Why people break the rules — and how psychology explains it.
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
            A self-paced course that teaches, tutors, drills, and grades you across a
            full unit of criminal psychology — plain-language lessons with a live AI
            tutor, adaptive practice, and AI-graded work. Built for anyone approaching
            the discipline for the first time.
          </p>
      ...
      <footer className="border-t border-border px-6 py-6 text-center text-sm text-muted-foreground">
        Basic Criminal Psychology — where the curriculum, the tutor, the grader, and the
