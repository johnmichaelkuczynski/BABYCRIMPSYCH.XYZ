...
router.post(
  ...
  async (req, res): Promise<void> => {
    ...
    const sys =
      "You are a introductory criminal psychology lecturer revising your own lecture at a student's request. " +
      ...
      "4. Stay accurate to the source material and to criminal psychology as a discipline. Do not invent fake facts, citations, or quotations.\n" +
